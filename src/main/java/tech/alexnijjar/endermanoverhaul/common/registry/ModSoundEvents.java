...
public class ModSoundEvents {
    ...
    public static final RegistryEntry<SoundEvent> CAVE_ENDERMAN_AMBIENT = SOUND_EVENTS.register("cave_enderman_ambient", () ->
        SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath(EndermanOverhaul.MOD_ID, "cave_enderman_ambient")));

    public static final RegistryEntry<SoundEvent> CAVE_ENDERMAN_HURT = SOUND_EVENTS.register("cave_enderman_hurt", () ->
        SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath(EndermanOverhaul.MOD_ID, "cave_enderman_hurt")));

    public static final RegistryEntry<SoundEvent> PLANT_ENDERMAN_AMBIENT = SOUND_EVENTS.register("plant_enderman_ambient", () ->
        SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath(EndermanOverhaul.MOD_ID, "plant_enderman_ambient")));

    public static final RegistryEntry<SoundEvent> PLANT_ENDERMAN_HURT = SOUND_EVENTS.register("plant_enderman_hurt", () ->
        SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath(EndermanOverhaul.MOD_ID, "plant_enderman_hurt")));

    public static final RegistryEntry<SoundEvent> TALL_ENDERMAN_AMBIENT = SOUND_EVENTS.register("tall_enderman_ambient", () ->
        SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath(EndermanOverhaul.MOD_ID, "tall_enderman_ambient")));

    public static final RegistryEntry<SoundEvent> TALL_ENDERMAN_DEATH = SOUND_EVENTS.register("tall_enderman_death", () ->
        SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath(EndermanOverhaul.MOD_ID, "tall_enderman_death")));

    public static final RegistryEntry<SoundEvent> TALL_ENDERMAN_STARE = SOUND_EVENTS.register("tall_enderman_stare", () ->
        SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath(EndermanOverhaul.MOD_ID, "tall_enderman_stare")));

    public static final RegistryEntry<SoundEvent> DARK_OAK_ENDERMAN_AMBIENT = SOUND_EVENTS.register("dark_oak_enderman_ambient", () ->
        SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath(EndermanOverhaul.MOD_ID, "dark_oak_enderman_ambient")));

    public static final RegistryEntry<SoundEvent> DARK_OAK_DARKNESS = SOUND_EVENTS.register("dark_oak_enderman_darkness", () ->
        SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath(EndermanOverhaul.MOD_ID, "dark_oak_enderman_darkness")));
    ...
    public static final RegistryEntry<SoundEvent> BUBBLE_PEARL_HIT = SOUND_EVENTS.register("bubble_pearl_hit", () ->
        SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath(EndermanOverhaul.MOD_ID, "bubble_pearl_hit")));

    public static final RegistryEntry<SoundEvent> BUBBLE_PEARL_THROWN = SOUND_EVENTS.register("bubble_pearl_thrown", () ->
        SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath(EndermanOverhaul.MOD_ID, "bubble_pearl_thrown")));

    public static final RegistryEntry<SoundEvent> CORRUPTED_PEARL_HIT = SOUND_EVENTS.register("corrupted_pearl_hit", () ->
        SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath(EndermanOverhaul.MOD_ID, "corrupted_pearl_hit")));

    public static final RegistryEntry<SoundEvent> SOUL_PEARL_HIT = SOUND_EVENTS.register("soul_pearl_hit", () ->
        SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath(EndermanOverhaul.MOD_ID, "soul_pearl_hit")));

    public static final RegistryEntry<SoundEvent> SUMMONER_PEARL_HIT = SOUND_EVENTS.register("summoner_pearl_hit", () ->
        SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath(EndermanOverhaul.MOD_ID, "summoner_pearl_hit")));

    public static final RegistryEntry<SoundEvent> ICY_PEARL_HIT = SOUND_EVENTS.register("icy_pearl_hit", () ->
        SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath(EndermanOverhaul.MOD_ID, "icy_pearl_hit")));
}
