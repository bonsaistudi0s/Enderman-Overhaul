...
public class ModParticleTypes {
    public static final ResourcefulRegistry<ParticleType<?>> PARTICLE_TYPES = ResourcefulRegistries.create(Registry.PARTICLE_TYPE, EndermanOverhaul.MOD_ID);
    ...
    public static final RegistryEntry<SimpleParticleType> FRIENDERMAN = PARTICLE_TYPES.register("frienderman", () -> new SimpleParticleType(false) {});
}
