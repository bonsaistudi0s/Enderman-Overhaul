...
public class ModItems {
    ...
    public static final RegistryEntry<Item> OCEAN_ENDERMAN_SPAWN_EGG = SPAWN_EGGS.register("ocean_enderman_spawn_egg", createSpawnEggItem(ModEntityTypes.OCEAN_ENDERMAN, 0x2b334a, 0x38a8a6, new Item.Properties()));
