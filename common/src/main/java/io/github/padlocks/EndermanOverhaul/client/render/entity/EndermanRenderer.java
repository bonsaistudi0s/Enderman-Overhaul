...
public class EndermanRenderer extends AnimatedEntityRenderer<BaseEnderman> {
    public static final ResourceLocation ENDERMAN_LOCATION = new ResourceLocation(EndermanOverhaul.MOD_ID, "default_enderman");
    ...
    private static final ResourceLocation[] ANGRY_RUN_ANIMATION = new ResourceLocation[]{new ResourceLocation(EndermanOverhaul.MOD_ID, "enderman.setup"), new ResourceLocation(EndermanOverhaul.MOD_ID, "enderman.angry_run")};
    ...
    public EndermanRenderer(EntityRendererProvider.Context context) {
        super(context, new ResourceLocation(EndermanOverhaul.MOD_ID, "default_enderman"), 1.0F);
    }

    @Override
    public ResourceLocation[] getAnimations(BaseEnderman entity) {
        if (entity.isAngry() && !isMoving)
            return ANGRY_ANIMATION;
        else if (entity.isAngry() && isMoving)
