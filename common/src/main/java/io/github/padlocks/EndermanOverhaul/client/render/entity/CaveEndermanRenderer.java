...
public class CaveEndermanRenderer extends AnimatedEntityRenderer<BaseEnderman> {
    public static final Identifier ENDERMAN_LOCATION = new Identifier(EndermanOverhaul.MOD_ID, "cave_enderman");
    ...
    public CaveEndermanRenderer(EntityRendererFactory.Context context) {
        super(context, new Identifier(EndermanOverhaul.MOD_ID, "cave_enderman"), 1.0F);
    }
    ...
    public Identifier getTexture(BaseEnderman entity) {
         return new Identifier(EndermanOverhaul.MOD_ID, "textures/entity/cave/cave_enderman.png");
    }
}
